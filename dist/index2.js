...
dotenv.config();
async function main() {
    const credential = new identity_1.ClientCertificateCredential(process.env.VINAY_TENANT_ID, process.env.VINAY_CLIENT_ID, process.env.VINAY_CERTIFICATEPATH);
    try {
        ...
        const client = (0, redis_1.createClient)({
            ...
            url: `redis://walmartserviceprincipal:${accessToken.token}@${process.env.VINAY_HOSTNAME}:6379`,
        });
